...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "xjnRQc0-bGXKC8qBgGcgCg";
	private static final String CLIENT_SECRET = "0jCCQX9eLn5tIvXtWIXomAIuK4qXMRY2Z0q2d0pFOsQrYDFyejG7Ewx7BaTbd2GY";
	...
	private String getAccessToken() {
		...
		try {
			...
			connection.setRequestMethod("POST"); // 比get安全，因为get要在url里面。post在body里面，可以加密
